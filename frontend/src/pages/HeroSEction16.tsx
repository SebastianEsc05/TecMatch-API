  ...
  return (
    <>
      ...
      <header className="bg-white p-8 max-h-screen flex flex-col w-full">
        <div className="grid flex-1 place-items-stretch lg:mt-8">
          <div className="container mx-auto text-center lg:mt-20 mb-19">
            <Typography
              placeholder
            ...
            >
              <span className="hidden md:block">
                Ha llegado el momento de que esté bien ser genial. <br />
                De ser un color brillante. De destacar.
              </span>
            </Typography>
          ...
          <div className="mx-auto max-w-[70%] grid grid-cols-1 gap-3 self-end md:grid-cols-2 lg:grid-cols-3 mt-20 max-w-full sm:max-w-3xl lg:max-w-5xl">
            <a
            ...
            >
              ...
              >
                ...
                >
                  Consulta más información sobre nuestra institución educativa,
                  oferta académica y nuestra comunidad.
                </Typography>
              </Card>
            </a>
            <a
            ...
            >
              ...
              >
                ...
                <Typography
                  ...
                  className="font-normal opacity-70"
                >
                  Las contribuciones siempre son bienvenidas, consulta el
                  repositorio para obtener más información.
                </Typography>
              </Card>
            </a>
            <a
              href="https://discord.gg/EnujxcnJ"
              target="_blank"
              rel="noreferrer"
            >
              <Card
